...
if (isset($_FILES['pdf'])) {
    ...
    if (move_uploaded_file($arquivo['tmp_name'], $caminhoArquivo)) {
        ...
        echo json_encode(["status" => "erro", "message" => "Erro ao gerar/salvar o TRI. Entre em contato com o
        Administrador da Rede Local."]);
    }
} else {
    echo json_encode(["status" => "erro", "message" => "Nenhum arquivo TRI foi criado. Entre em contato com o
        Administrador da Rede Local"]);
}
?>